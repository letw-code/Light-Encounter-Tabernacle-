...
export default function SermonsGrid() {
    return (
        <section className="py-6 bg-[#140152]">
            <div className="section-container">
                <div className="text-center space-y-4 mb-16">
                    <div className="flex items-center justify-center gap-2 text-[#a57b00] font-bold tracking-widest text-sm uppercase">
                        <div className="w-2 h-2 rotate-45 bg-[#a57b00]" />
                        Our Sermons
                    </div>
                    <h2 className="text-4xl md:text-5xl font-heading font-black text-white/90 uppercase">
                        Our Latest <span className="text-[#a57b00] italic">Sermons</span>
                    </h2>
                </div>
                    ...
                    {sermons.map((sermon, i) => (
                        ...
                        >
                            ...
                            <div className="relative h-64 overflow-hidden">
                                ...
                                />
                                <div className="absolute top-6 left-6 bg-[#140152] text-white p-2 rounded-xl text-center min-w-[50px]">
                            ...
                            <div className="p-8 space-y-6 flex-1 flex flex-col">
                                <h3 className="text-2xl font-bold font-heading text-zinc-900 leading-tight group-hover:text-[#140152] transition-colors cursor-pointer">
                                    {sermon.title}
                                </h3>
                                ...
                                <div className="pt-2 mt-auto border-t border-zinc-100">
                                    <Link href="/sermons" className="flex items-center justify-between text-[#140152] font-bold group/link">
                                        Watch Sermon
