...
import { authApi, userApi, User, tokenManager } from '@/lib/api'
...
export default function UserSettingsPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            {/* DashboardNavbar is handled by ConditionalLayout */}

            <main className="max-w-4xl mx-auto px-4 py-8">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-[#140152]">Settings</h1>
                    ...
                    <div className="p-6">
                        <AnimatePresence mode="wait">
                            {activeTab === 'profile' && (
                                ...
                                >
                                    {/* Profile Info Card */}
                                    <div className="mb-8 p-6 bg-gradient-to-r from-[#140152] to-[#1d0175] rounded-xl text-white">
                                        ...
                                        <div className="mt-4 pt-4 border-t border-white/20 flex gap-6 text-sm">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-white/70">Member since {new Date(user?.created_at || '').toLocaleDateString()}</span>
                                            </div>
                                        </div>
                                    </div>
