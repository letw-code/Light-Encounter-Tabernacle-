        ...
        <div className="max-w-5xl mx-auto space-y-16">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="bg-orange-50 p-8 rounded-[2rem]">
              ...
              <Link href="/kids-ministry" className="inline-block bg-orange-500 hover:bg-orange-600 text-white rounded-full px-6 py-2.5 font-medium transition-colors">
                Explore Kids Ministry
              </Link>
            </div>

            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-[2rem] border border-blue-100/50 shadow-sm relative overflow-hidden">
