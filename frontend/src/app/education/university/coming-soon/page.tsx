...
export default function UniversityComingSoonPage() {
    return (
            ...
            <div className="max-w-2xl w-full bg-white dark:bg-neutral-800 rounded-3xl shadow-2xl overflow-hidden relative">
                ...
                <div className="relative p-8 md:p-12 text-center">
                    <motion.div
                        ...
                        className="w-24 h-24 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center mx-auto mb-8"
                    >
                    ...
                    >
                        We are building our dedicated university portal to serve you better. Please check back soon for updates on admissions, programmes, and campus life.
                    </motion.p>
                ...
                {/* Bottom decoration */}
                <div className="h-2 bg-gradient-to-r from-purple-400 via-[#140152] to-emerald-500" />
            </div>
        </div>
    )
}
